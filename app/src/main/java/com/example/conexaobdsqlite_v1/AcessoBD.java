    ...
    public class AcessoBD extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            String statement = "CREATE TABLE " + TABELA_USUARIO + " (" + USUARIO_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + USUARIO_NOME + " TEXT, " + USUARIO_IDADE + " INT)";
            //"CREATE TABLE TABELA_USUARIO(USUARIO_ID INTEGER PRIMARY KEY AUTOINCREMENT,
